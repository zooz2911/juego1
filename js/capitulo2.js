...
function showFinalResults() {
    ...
    if (levelCompleted) {
        ...
        if (currentLevel === 'facil') {
            ...
            showConfetti();
            levelMessage = `👑 ¡Nivel Difícil Dominado! ¡Has completado el Capítulo 2! 👑 (${percentage}%)`;
    ...
    domElements.finalResults.innerHTML = `
        <div class="final-results-content">
            <h2>🎉 ${currentLevel === 'dificil' && levelCompleted ? '¡CAPÍTULO 2 COMPLETADO!' : '¡NIVEL COMPLETADO!'} 🎉</h2>
